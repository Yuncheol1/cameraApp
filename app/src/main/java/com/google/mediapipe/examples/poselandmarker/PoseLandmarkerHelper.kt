...
class PoseLandmarkerHelper(
    ...
    private fun returnLivestreamResult(
        ...
        try {
            ...
            // ✅ JSON 생성 (landmark 하나만 보내는 테스트)
            val jsonList = landmarks/*.take(1)*/.mapIndexed { index, landmark ->
                """{
                "id": $index,
                "x": ${landmark.x()},
                "y": ${landmark.y()},
        ...
        """.trimIndent()
            ...
            landmarks.forEachIndexed { index, landmark ->
                Log.d(
                    "PoseLog",
                    "Landmark $index: x=${landmark.x()}, y=${landmark.y()}, z=${landmark.z()}, visibility=${landmark.visibility()}"
                )
            }
            ...
            Log.e("PoseDebug", "❌ returnLivestreamResult()에서 예외 발생: ${e.message}", e)
        }
    }
